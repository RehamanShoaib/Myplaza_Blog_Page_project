...
export const socialMediaProfiles = [
  { title: 'Facebook', href: 'https://www.instagram.com/myplaza_io/', icon: FacebookIcon },
  { title: 'Instagram', href: 'https://www.instagram.com/myplaza_io/', icon: InstagramIcon },
  { title: 'Twitter', href: 'https://www.twitter.com/myplaza_io/', icon: TwitterIcon },
  { title: 'Linkedin', href: 'https://www.linkedin.com/myplaza/', icon: DribbbleIcon },
]
